                        ...
                        <div class="col-12 mt-4" style="padding-left:40px;padding-right:50px;">
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <img class="d-block" src="img/hienho.jpg" alt="First slide" style="width:100%;height:200px;">
                                    </div>
                                    <div class="carousel-item">
                                    <img class="d-block" src="img/sontung.jpg" alt="Second slide" style="width:100%;height:200px;">
                                    </div>
                                    <div class="carousel-item">
                        ...
                        <div class="col-12 mt-3 " style="padding-left:30px;">
                            <div class="row">
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12">
                                            <img class="carousel-inner" src="img/hienho.jpg" alt="" style="width:88%;">
                                        </div>
